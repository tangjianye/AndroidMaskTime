...
import com.peach.masktime.ui.service.LocalPlayerService;
 ...
 */
public class LocalMusicContrlLayer extends FrameLayout implements View.OnClickListener {
    ...
    public LocalMusicContrlLayer(Context context) {
        super(context);
    }

    public LocalMusicContrlLayer(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public LocalMusicContrlLayer(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setPlayStatus(LocalMusicContrlLayer.Status status) {
        mStatus = status;
        ...
        getContext().startService(CommUtils.getMaskIntent(
                getContext().getApplicationContext(), bundle, LocalPlayerService.class));
    }
}
